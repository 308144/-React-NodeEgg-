...
import { AddUserModal } from '@/pages/Faculty/Modal';
import styles from './index.module.less';
import { useModel } from '@/store';
import { findAllFaculty, echoOneFacultyData } from '@/pages/Faculty/api';
    ...
    return (React.createElement(PageContainer, { breadcrumb: breadcrumb },
        React.createElement(GridContent, null,
            React.createElement(ProTable, { toolBarRender: () => [
                    React.createElement(Button, { key: 'add', disabled: userInfo.identity === 'student', onClick: showModal, icon: React.createElement(PlusOutlined, null), type: 'primary' }, "\u65B0\u589E\u9662\u7CFB"),
